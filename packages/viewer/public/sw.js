// Hand-rolled Service Worker for the viewer — no vite-plugin-pwa or other
...
//    visit, same as any cache-as-you-go strategy. A catalog opened via
//    `?src=<url>` still needs the network for that fetch every time,
