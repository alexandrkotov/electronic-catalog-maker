...
export * from "./i18n.js";
export { EDITOR_LOCALES, EDITOR_LOCALE_NAMES, editorMessages } from "./locales/editor/index.js";
export { VIEWER_LOCALES, VIEWER_LOCALE_NAMES, viewerTranslator } from "./locales/viewer/index.js";
