 ...
 */
export const EDITOR_LOCALES = ["en"] as const;

/** Each language's own name for itself — shown in the language picker, never translated. */
export const EDITOR_LOCALE_NAMES: Record<string, string> = { en: "English" };

export const editorMessages: Record<string, Messages> = { en };
